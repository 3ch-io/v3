...
postbutton += '<div class="postbutton" style="display:none">'+
	      ...
	      ' </a>'+
	      '</div>';
document.getElementById('body').innerHTML += '<link href="https://delight.rentalbbs.net/css/sp.css" rel="stylesheet">'+postbutton;
}
if (localStorage.getItem('darkmode') == "true") {
document.getElementById('body').innerHTML += '<link href="https://delight.rentalbbs.net/css/dark.css" rel="stylesheet">';
