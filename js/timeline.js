...
function load() {
 ...
 request.onload = function() {
  ...
  newpost.id = n;
  if (isSmartPhone() == false) newpost.innerHTML = '<span class="number">'+n+'</span><span class="name"><b>'+name+'</b></span><span class="date">'+date+' <span class="ids"><a class="id" href="javascript:IdClick(\''+id+'\')">'+id+'</a></span></span><div class="message">'+comment+'</div><a href="/#'+bbs+'/'+thread+'/"><div class="subject">'+title+'</div></a>';
  else newpost.innerHTML = '<span class="number">'+n+'</span><span class="name">'+name+'</span><div class="message">'+comment+'</div><span class="date"><span class="ids"><a class="id" href="javascript:IdClick(\''+id+'\')">'+id+'</a></span>'+date+'</span><a href="/#'+bbs+'/'+thread+'/"><div class="subject">'+title+'</div></a>';
...
function Menu() {
document.getElementById('modal_text').innerHTML = '<div style="font-weight:bold;">ミュート設定</div><a class="menulink" href="javascript:mute(\'list\')">ID</a>&emsp;<a class="menulink" href="javascript:MenuClick(\'ngword\')">Word</a>&emsp;<a class="menulink" href="javascript:MenuClick(\'ngtitle\')">タイトル</a><div style="font-weight:bold;">その他</div><a class="menulink" href="javascript:MenuClick(\'setting\')">閲覧設定</a>&emsp;<a class="menulink" href="/test/backimg.html">背景画像</a>&emsp;<a class="menulink" href="javascript:setclear()">全ログを削除</a><br><a class="menulink" href="/test/login.html">ログイン</a>';
document.getElementById('rModal').style.display = 'block';
}
...
function IdClick(value) {
      ...
      for (let i = 0; i < idcount; i++) {
        ins += '<div>'+document.getElementsByClassName(value)[i].innerHTML+'</div>';
      }
